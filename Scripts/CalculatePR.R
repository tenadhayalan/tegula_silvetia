...
Sample.Info <- read.csv(file = here("Short_term",
                                    "Data_Raw",
                                    "PR",
                                    "PR_initial",
                                    "Metadata",
                                    "PR_initial_metadata_2021_09_13.csv"))
#View(Sample.Info)
...
for (i in 1: length(file.names.full)) {
  ...
  pdf(paste0(here("Short_term","Output","RespoOutput"),"/", rename,"thinning.pdf"))
...
write_csv(Respo.R, here("Short_term", 
                        "Data",
                        "PR",
                        "Respo.R.csv"))  

Respo.R <- read_csv(here("Short_term", 
                        "Data",
                        "PR",
                        "Respo.R.csv"))  
...
write_csv(Respo.R_Normalized,here("Short_term",
                                  "Data",
                                  "PR",
                                  "PR_initial_normalized.csv"))# export all the uptake rates
#View(Respo.R)
